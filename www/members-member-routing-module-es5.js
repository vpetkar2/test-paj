...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["members-member-routing-module"], {
  ...
  function srcAppMembersMemberRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [// { path: 'map', loadChildren: './map/map.module#MapPageModule' },
    // { path: 'map', canActivate: [AuthGuard], loadChildren: './members/map/map.module#MapPageModule' },
    {
      ...
      loadChildren: './device-management/device-management.module#DeviceManagementPageModule'
    }, {
      path: 'deafult-icons',
      loadChildren: './device-management/modal/deafult-icons/deafult-icons.module#DeafultIconsPageModule'
    }, {
      path: 'device-img',
      loadChildren: './device-management/modal/device-img/device-img.module#DeviceImgPageModule'
    }, {
      path: 'dashboard',
      loadChildren: './dashboard/dashboard.module#DashboardPageModule'
    }, {
      path: 'device-details',
      loadChildren: './dashboard/modal/device-details/device-details.module#DeviceDetailsPageModule'
    }, {
      path: 'about-us',
